...
class SeriesAPI:
    ...
    async def get_series(self, series_id: str, *, params: Mapping[str, Any] | None = None) -> SeriesResponse:
    ...
    async def search_series(self, search_text: str, *, params: Mapping[str, Any] | None = None) -> SeriesResponse:
    ...
    async def get_series_categories(self, series_id: str, *, params: Mapping[str, Any] | None = None) -> CategoryResponse:
        query = {"series_id": series_id}
        if params:
            query.update(dict(params))
    ...
    async def get_series_observations(self, series_id: str, *, params: Mapping[str, Any] | None = None) -> SeriesObservationsResponse:
        query = {"series_id": series_id}
        if params:
            query.update(dict(params))
    ...
    async def get_series_release(self, series_id: str, *, params: Mapping[str, Any] | None = None) -> ReleaseSingleResponse:
        query = {"series_id": series_id}
        if params:
            query.update(dict(params))
    ...
    async def get_series_tags(self, series_id: str, *, params: Mapping[str, Any] | None = None) -> TagsResponse:
        query = {"series_id": series_id}
        if params:
            query.update(dict(params))
    ...
    async def search_series_tags(self, series_search_text: str, *, params: Mapping[str, Any] | None = None) -> TagsResponse:
    ...
    async def search_series_related_tags(self, series_search_text: str, *, params: Mapping[str, Any] | None = None) -> RelatedTagsResponse:
        query = {"series_search_text": series_search_text}
        if params:
            query.update(dict(params))
    ...
    async def get_series_updates(self, *, params: Mapping[str, Any] | None = None) -> SeriesUpdatesResponse:
        data = await self._client.get("/fred/series/updates", params=params)
        return SeriesUpdatesResponse.model_validate(data)

    async def get_series_vintage_dates(self, series_id: str, *, params: Mapping[str, Any] | None = None) -> SeriesVintageDatesResponse:
        query = {"series_id": series_id}
        if params:
            query.update(dict(params))
